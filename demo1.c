...
int main()
{
    //     system("Color a"); // this line of code is used to change color of the background and text.
        ...
        if (loginCheck)
        {
            while (IsRunning)
            {
                ...
                case 10:
                {
                    printf("Case 9\n");
                    system("cls");
                    char loginoutText[]= "*** Louout successfully for UserID : ";
                    for(int i= 0; i< strlen(loginoutText); i++){
                        printf("%c", loginoutText[i]);
                        Sleep(30);
                    }
                    printf("%s ***\n\n", login_ID);
                    // printf("*** Louout successfully for UserID : %s ***\n\n", login_ID);
                    GoBackOrExit();
                    goto logoutLevel;
                    break;
                }
